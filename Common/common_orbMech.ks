...
FUNCTION orbMech_GravityVector {
    parameter v is ship:velocity:orbit, r is ship:body:position.
    // may return positive or negative, i honestly do not know!
    return r/r:mag^3*body:mu.
}
...
FUNCTION orbMech_VMN {
    parameter t, p,n,r, justBurnVector is true. // time, prograde, normal, radial component
    ...
    local pvRadial is vecNodeRadial*r.
